      ...
      <div className="min-h-screen bg-background text-foreground">
        <header className="sticky top-0 z-40 flex items-center justify-between border-b bg-background/95 px-6 py-3.5 backdrop-blur-md lg:px-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              className="grid size-11 min-h-[44px] min-w-[44px] place-items-center rounded-full border bg-card transition hover:border-foreground/40 lg:hidden"
            ...
            <div className="hidden items-center gap-4 lg:flex">
              <Link
                ...
                target="_blank"
                className="inline-flex min-h-[44px] items-center gap-1.5 rounded-full border bg-card px-4 py-2 text-xs font-medium transition hover:border-foreground/40 hover:bg-secondary"
              >
              ...
              <button
                onClick={logout}
                disabled={loggingOut}
                className="inline-flex min-h-[44px] items-center gap-1.5 rounded-full border border-transparent px-4 py-2 text-xs font-medium text-muted-foreground transition hover:border-border hover:bg-card hover:text-foreground disabled:opacity-50"
              >
              ...
              <div>
                <div className="mb-6 flex items-center justify-between border-b pb-4">
                  ...
                  <Link
                    ...
                    className="inline-flex min-h-[44px] items-center gap-1 rounded-full border bg-card px-3.5 py-2 text-xs font-medium"
                  >
